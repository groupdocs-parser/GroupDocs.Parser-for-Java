...
`[Features](https://apireference.groupdocs.com/java/parser/com.groupdocs.parser.options/Features "class in com.groupdocs.parser.options")` class has the following members:

| Member | Description |
| --- | --- |
| boolean `**[isFeatureSupported](https://apireference.groupdocs.com/java/parser/com.groupdocs.parser.options/Features#isFeatureSupported(java.lang.String))**([String](http://docs.oracle.com/javase/7/docs/api/java/lang/String.html?is-external=true "class or interface in java.lang") featureName)` | Returns the value that indicates whether the **feature** is supported. |
